public class Main {
    ...
    public static void task8() {
        ...
        for (int i = 1; i <= 12; i++) {
            amountSavings += depositAmount;
            System.out.println("Месяц " + i + ", сумма накопления равна " + amountSavings + " рублей");
        }
    }

    public static void task9() {
        System.out.println("Задача 9:");
        float amountSavings = 0;
        int depositAmount = 29000;
        for (int i = 1; i <= 12; i++) {
            amountSavings = amountSavings + amountSavings / 100;
            amountSavings = amountSavings + depositAmount;
            System.out.println("Месяц " + i + ", сумма накопления равна " + amountSavings + " рублей");
        }
    }
